...
%
\begin{equation}
q^{\,l}_{aa}:=\mathbb{E}\!\left[\left(z^{\,l}_{i;a}\right)^{2}\right], \qquad \mathbb{E}\!\left[z^{\,l}_{i;a}\right]=0 .
\end{equation}
%
...
%
\begin{equation}
\mathbb{E}\!\left[z^{\,l}_{i;a}z^{\,l}_{j;b}\right] = q^{\,l}_{ab}\,\delta_{ij}.
\end{equation}
%
...
%
\begin{equation}
\chi_{1} \equiv \left.\frac{\partial c^{\,l}_{ab}}{\partial c^{\,l-1}_{ab}}\right|_{c_{ab}=1} = \sigma_{w}^{2}\int Dz \,\big[\phi'(\sqrt{q^{*}}\,z)\big]^{2}.
\end{equation}
%
...
%
\begin{equation}
\int Dz\,\big(\phi'(\sqrt{q^{*}}\,z)\big)^{2} = \int Dz\,\theta(z) = \frac{1}{2}.
\end{equation}
%
Hence
%
\begin{equation}
\chi_{1}=\frac{\sigma_{w}^{2}}{2}, \qquad \chi_{1}=1 \ \Longrightarrow\ \sigma_{w}^{2}=2,
\end{equation}
%
...
%
\begin{equation}
\epsilon^{\,l+1}_{q} = \epsilon^{\,l}_{q} \Bigg[ \chi_{1} + \sigma_{w}^{2}\int Dz\,\phi''(\sqrt{q^{*}}z)\,\phi(\sqrt{q^{*}}z) \Bigg].
\end{equation}
%
Defining
%
\begin{equation}
r_{q} \equiv \chi_{1} + \sigma_{w}^{2}\int Dz\,\phi''(\sqrt{q^{*}}z)\,\phi(\sqrt{q^{*}}z),
\end{equation}
%
we have asymptotically
%
\begin{equation}
\epsilon^{\,l}_{q} = \epsilon^{\,0}_{q}\,r_{q}^{\,l} = \epsilon^{\,0}_{q}\,e^{-l/\xi_{q}}, \qquad \xi_{q}^{-1}\equiv -\log|r_{q}|.
\label{app:corrq}
\end{equation}
%
...
%
\begin{align}
&\xi_{c}^{-1} = -\log\!\left[ \sigma_{w}^{2} \int Dz_{1}\,Dz_{2}\,\phi'(u_{1}^{*})\,\phi'(u_{2}^{*}) \right],\\
&u_{1}^{*}=\sqrt{q^{*}}\,z_{1},\quad u_{2}^{*}=\sqrt{q^{*}}\!\left(c^{*}z_{1}+\sqrt{1-(c^{*})^{2}}\,z_{2}\right).
\end{align}
%
